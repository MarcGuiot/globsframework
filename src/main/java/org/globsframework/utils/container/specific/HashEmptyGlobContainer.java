package org.globsframework.utils.container.specific;
...
public class HashEmptyGlobContainer implements HashContainer<Key, Glob> {
    static final boolean fallback = Boolean.getBoolean("org.globsframework.utils.container.specific.fallback");
